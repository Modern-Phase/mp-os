...
const GLOBAL_TEMPLATES = [
  {
    ...
    taskTemplates: [
      { title: "Draft SOW and project contract", description: "Prepare statement of work and client contract for signature", agentId: AGENT_IDS.CARL, priority: "high" as const, tags: ["legal", "contracts"], order: 0 },
      ...
      { title: "Brand discovery and wireframes", description: "Run brand workshop, gather assets, and produce initial wireframes", agentId: AGENT_IDS.DANA, priority: "high" as const, tags: ["design", "ux"], order: 3 },
      ...
      { title: "Schedule kickoff meeting with client", description: "Coordinate calendars and send agenda for project kickoff", agentId: AGENT_IDS.SAM, priority: "medium" as const, tags: ["scheduling"], order: 5 },
      ...
      { title: "UI component library and design system", description: "Build reusable component library matching brand guidelines", agentId: AGENT_IDS.DANA, priority: "medium" as const, tags: ["design"], order: 7 },
  ...
  },
  {
    ...
    isGlobal: true as const,
    taskTemplates: [
      { title: "MSA and SaaS-specific terms", description: "Draft master service agreement with SaaS licensing, data handling, and SLA terms", agentId: AGENT_IDS.CARL, priority: "high" as const, tags: ["legal"], order: 0 },
      ...
      { title: "MVP user flows and prototype", description: "Map critical user journeys and build interactive prototype for validation", agentId: AGENT_IDS.DANA, priority: "high" as const, tags: ["design", "ux"], order: 2 },
      ...
      { title: "Design polish and accessibility", description: "Refine UI details, ensure WCAG compliance, and optimize responsive layouts", agentId: AGENT_IDS.DANA, priority: "medium" as const, tags: ["design"], order: 6 },
      ...
      { title: "Launch content and product announcement", description: "Write launch blog post, social media content, and product hunt copy", agentId: AGENT_IDS.MAYA, priority: "medium" as const, tags: ["marketing"], order: 9 },
    ],
  },
  {
    name: "Brand Package",
    ...
    isGlobal: true as const,
    taskTemplates: [
      { title: "Creative services agreement", description: "Draft contract covering IP ownership, revisions, and deliverables scope", agentId: AGENT_IDS.CARL, priority: "high" as const, tags: ["legal"], order: 0 },
      { title: "Brand discovery workshop and brief", description: "Facilitate brand workshop, synthesize findings into a creative brief", agentId: AGENT_IDS.DANA, priority: "high" as const, tags: ["design", "brand"], order: 1 },
      { title: "Logo and visual identity system", description: "Design logo, color palette, typography, and iconography system", agentId: AGENT_IDS.DANA, priority: "high" as const, tags: ["design"], order: 2 },
      { title: "Brand guidelines document", description: "Compile comprehensive brand guidelines covering all visual and usage standards", agentId: AGENT_IDS.DANA, priority: "medium" as const, tags: ["design", "docs"], order: 3 },
      { title: "Brand voice and messaging guide", description: "Define tone of voice, key messages, taglines, and copywriting standards", agentId: AGENT_IDS.MAYA, priority: "medium" as const, tags: ["marketing", "content"], order: 4 },
      { title: "Collateral and asset delivery", description: "Produce business cards, social templates, and export all assets in required formats", agentId: AGENT_IDS.DANA, priority: "medium" as const, tags: ["design", "delivery"], order: 5 },
